...
import { TextGenerateEffect } from './ui/TextGeneratorEfeect';
...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        <div className=''>
            <Spotlight className='top-10 left-full  h-screen' fill='white'/> 
            <Spotlight className='-top-40 -left-10 md:-left-32 md:-top-20 h-screen' fill='white'/> 
            <Spotlight className='top-20 left-70  h-screen' fill='white'/> 
            </div>
